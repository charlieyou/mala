...
class OrchestratorState:
    ...
    Attributes:
        ...
        review_in_progress_issue_ids: Issues that were already in_progress when
            claimed in review-recovery mode.
    ...
    review_in_progress_issue_ids: set[str] = field(default_factory=set)
