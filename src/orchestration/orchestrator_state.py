...
class OrchestratorState:
    ...
    Attributes:
        ...
        active_session_log_paths: Maps agent_id to session log path for deadlock handling.
        deadlock_cleaned_agents: Tracks agents cleaned during deadlock resolution.
    """
