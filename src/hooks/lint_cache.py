"""Lint command caching hook for Claude Agent SDK.

Contains the LintCache class and make_lint_cache_hook factory
for blocking redundant lint command executions during agent sessions.
"""
