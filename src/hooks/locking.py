"""Lock enforcement hooks for Claude Agent SDK.

Contains PreToolUse hooks for enforcing file lock ownership and
Stop hooks for cleaning up locks when agents terminate.
"""
