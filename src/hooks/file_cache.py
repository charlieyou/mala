"""File read caching hook for Claude Agent SDK.

Contains the FileReadCache class and make_file_read_cache_hook factory
for blocking redundant file reads during agent sessions.
"""
