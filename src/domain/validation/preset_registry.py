...
class PresetRegistry:
    ...
    def get(self, name: str) -> ValidationConfig:
        ...
        # Validate that commands/run_level_commands only contain built-in keys
        ...
        self._validate_preset_commands(
            data.get("run_level_commands"), "run_level_commands"
        )
    ...
    def _validate_preset_commands(
        ...
        Args:
            commands_data: The 'commands' or 'run_level_commands' section
