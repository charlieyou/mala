...
def run_mutex(
    args: list[str], env: dict, timeout: float | None = 10.0
...
class TestMutexRelease:
    ...
    def test_mutex_released_after_success(self, mutex_env):
    ...
    def test_mutex_released_after_failure(self, mutex_env):
...
class TestMutexContention:
    ...
    def test_reports_holder_when_blocked(self, mutex_env):
    ...
    def test_does_not_run_command_when_blocked(self, mutex_env):
...
class TestMutexRaceConditions:
    ...
    def test_exactly_one_racer_wins(self, mutex_env):
...
class TestErrorHandling:
    ...
    def test_fails_without_lock_dir(self, mutex_env):
    ...
    def test_fails_without_agent_id(self, mutex_env):
    ...
    def test_fails_without_command(self, mutex_env):
...
class TestSignalHandling:
    ...
    def test_mutex_released_on_interrupt(self, mutex_env):
