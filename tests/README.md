...
|--------------|-----------|
| `tests/unit/domain/test_quality_gate.py` | Most tests use `MagicMock` for `CommandRunnerPort` to satisfy constructor; tests focus on log parsing, not command execution. This is a documented exception. |
